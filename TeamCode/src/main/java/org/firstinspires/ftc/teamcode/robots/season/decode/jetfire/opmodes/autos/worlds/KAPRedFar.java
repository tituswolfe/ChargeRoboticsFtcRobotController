...
@Autonomous(name = "KAP (RED+FAR)", preselectTeleOp = "Jetfire")
public class KAPRedFar extends BaseAuto<JetfireRobot> {
    ...
    Pose tunnelEnd = humanPlayerEnd; //new Pose(20, 10 + 16, Math.toRadians(-180)).mirror(); //tunnelStart.withX(20);
