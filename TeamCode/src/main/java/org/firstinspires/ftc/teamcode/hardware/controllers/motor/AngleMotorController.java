...
public class AngleMotorController extends MotorController {
    ...
    public void setTargetHeading(Angle angle) {
        ...
        if (angle.getAngle(Angle.AngleSystem.SIGNED) > maxPositiveLimit.getAngle(Angle.AngleSystem.SIGNED)) {
            targetHeading = maxPositiveLimit;
        } else if (angle.getAngle(Angle.AngleSystem.SIGNED) < minNegativeLimit.getAngle(Angle.AngleSystem.SIGNED)) {
            targetHeading = minNegativeLimit;
        } else {
            targetHeading = angle;
        }
