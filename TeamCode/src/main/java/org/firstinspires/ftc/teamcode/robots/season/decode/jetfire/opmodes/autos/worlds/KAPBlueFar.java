...
@Autonomous(name = "KAP (BLUE+FAR)", preselectTeleOp = "Jetfire")
public class KAPBlueFar extends BaseAuto<JetfireRobot> {
    ...
    Pose tunnelEnd = humanPlayerEnd; //new Pose(20, 10 + 16, Math.toRadians(-180)); //tunnelStart.withX(20);
